...
<script type="text/javascript">
		...
		function fn_remove_article(url,articleNO) {
			let form = document.createElement("form"); // js이용해 동적으로 form 태그 생성
			...
			form.appendChild(articleNOInput);		// 동적으로 생성된 input태그를 동적으로 생성한 formdp append
		...
		<table border="0" align="center">
			<tr>
				...
				<td><input type="text" value="${article.articleNO }" disabled />
					<%-- 글수정시 글번호를 컨트롤러에게 전송하기 위해 글번호 저장함 --%> <input type="hidden"
			...
			<tr id="tr_btn_modify">
				<td colspan="2" align="center"><input type="button"
					value="수정등록" onclick="fn_modify_article(frmArticle)" /> <input
